          ...
          <CardContent className="flex flex-col items-center justify-center py-10">
            <div className="text-center space-y-3 max-w-lg">
              ...
              <p className="text-gray-500">
                The department reports page is currently under development. Soon, this page will provide detailed analytics, downloadable reports, and performance insights for your department.
              </p>
