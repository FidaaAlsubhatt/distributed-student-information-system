          ...
          <CardContent className="flex flex-col items-center justify-center py-10">
            <div className="text-center space-y-3 max-w-lg">
              ...
              <p className="text-gray-500">
                The security monitoring dashboard is currently under development. Soon, this page will provide
                real-time security alerts, audit logs, and system health insights for university administrators.
              </p>
